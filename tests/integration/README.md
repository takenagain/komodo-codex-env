...
4. **test_kdf_sdk_integration.py** - Tests combined KDF-SDK setup and melos installation

### Unit Tests (Fast)

5. **test_android_fvm_paths.py** - Tests Android SDK and FVM path detection logic
6. **test_android_manager.py** - Tests Android manager functionality
7. **test_setup.py** - Tests setup configuration and mocking
8. **test_docs_location.py** - Tests documentation fetching behavior
...
- Executes setup command for KDF-SDK
- Verifies the `melos` CLI is installed
